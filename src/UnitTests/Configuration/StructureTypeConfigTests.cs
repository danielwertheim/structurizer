...
namespace UnitTests.Configuration
{
    ...
    public class StructureTypeConfigTests : UnitTests
    {
        ...
        public void Ctor_Should_throw_When_missing_type()
        {
            ...
            invalidAction.Should().Throw<ArgumentException>().And.ParamName.Should().Be("structureType");
        }
        ...
        public void Ctor_Should_throw_When_missing_member_paths()
        {
            ...
            invalidAction.Should().Throw<ArgumentException>().And.ParamName.Should().Be("memberPaths");
        }
